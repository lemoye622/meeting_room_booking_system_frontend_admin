...
export async function userSearch(username: string, nickName: string, email: string, page: number, limit : number) {
...
export async function meetingRoomList(name: string, capacity: number, equipment: string, page: number, limit: number) {
